...
class Decomposition1():
    ...
    def getFileName(param_dict):
        return 'Decomposition1_PG-{}'.format(param_dict['PG'].getFileName(param_dict['PG_param']))
...
if __name__ == '__main__':
    ...
    X_red, y_red = Decomposition1().reduceSet(X_train.toarray().copy(), y_train.toarray().copy(), params_dict)
