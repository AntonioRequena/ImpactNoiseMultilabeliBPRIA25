...
class Chen():
	...
	def getFileName(param_dict):
		return 'Chen_Red-{}'.format(param_dict['red'])
	...
	def generatePrototype(self, indexes):
        ...
        # Class:
		try:
			r_labelset = st.mode(self.y[indexes])
		except:
			r_labelset = random.choice(self.y[indexes])
...
if __name__ == '__main__':
	...
	params_dict = Chen.getParameterDictionary()
	params_dict['red'] = 50
	X_red, y_red = Chen().reduceSet(X_train.copy(), y_train.copy(), params_dict)
