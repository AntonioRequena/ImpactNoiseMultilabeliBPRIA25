...
class MRSP2():
	...
	def getFileName(param_dict):
		return 'MRSP2_Red-{}'.format(param_dict['red'])
...
if __name__ == '__main__':
	...
	params_dict = MRSP2.getParameterDictionary()
	params_dict['red'] = 90

	X_red, y_red = MRSP2().reduceSet(X_train.toarray().copy(), y_train.toarray().copy(), params_dict)
