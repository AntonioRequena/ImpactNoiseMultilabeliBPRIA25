...
class MRSP1():
	...
	def getFileName(param_dict):
		return 'MRSP1_Red-{}'.format(param_dict['red'])
...
if __name__ == '__main__':
	...
	params_dict = MRSP1.getParameterDictionary()
	params_dict['red'] = 90
	
	X_red, y_red = MRSP1().reduceSet(X_train.toarray().copy(), y_train.toarray().copy(), params_dict)
